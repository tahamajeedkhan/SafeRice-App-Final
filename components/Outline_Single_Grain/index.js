...
export default function Outline_Single_Grain() {
  ...
  const analyzeImage = async (imageUri) => {
    ...
    try {
      ...
      const url = `${config.getUrl("outline_Single_Grain")}/analyze`;
    ...
    <View style={styles.container}>
      <ImageBackground source={require('../../assets/background.png')} style={styles.backgroundImage}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <Text style={styles.title}>Single Grain Outliner</Text>
          
          {(outlinedImage) ? (
            <Image source={{ uri: outlinedImage }} style={styles.imagePreview} />
          ) : image ? (
          ...
          {loading && (
            <View style={styles.loadingContainer}>
              ...
              <Text style={styles.loadingText}>Analyzing rice grains...</Text>
            </View>
          )}
