...
const NutritionExtraction = ({ navigation }) => {
  ...
  const menuOptions = [
    ...
    },
    {
      ...
      navigateTo: 'Nutrition_Extraction_Multi', // Replace with your actual screen name
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.title}>Nutrition Extraction</Text>
...
export default NutritionExtraction;
